...
# The AddVox class adds a new voxels to the group nodes children
                    ...
                    for x in range (20):
                        if (z >= 0 and z <= 3):
                            ...
                            t, dn = createX3DNodeFromString ("""\
                                ...
                                z, x, y,
                                z))
                            if (z == 8 and ((x == 5 and (y == 3 or (y >= 7 and y <= 10) or y == 17))
                                  or (x == 6 and (y == 2 or (y >= 8 and y <= 10) or y == 16 or y == 17))
                                  or (x == 7 and (y == 2 or y == 9 or y == 10 or y == 16 or y == 17))
                                  or (x == 14 and (y == 6 or y == 7 or y == 13 or y == 14))
                                  or (x == 15 and ((y >= 5 and y <= 7) or y == 13))
                                  or (x == 16 and y == 6))):
                                c = RGB (0.5, 0.5, 0.5)
                                dn["MATERIAL%d%d%d" % (x, y, z)].diffuseColor.setValue (c)
                            elif (z == 8 and ((x == 2 and ((y >= 4 and y <= 13)))
                                  or (x == 3 and (y == 2 or y == 3 or (y >= 14 and y <= 16)))
                                  or (x == 4 and (y == 2 or y == 11 or y == 13 or y == 17))
                                  or ((x == 5 or x == 6) and (y == 1 or y == 12 or y == 18))
                                  or (x == 7 and (
                                    y == 1 or (y >= 3 and y <= 5) or (y >= 11 and y <= 13) or y == 15 or y == 18))
                                  or (x == 8 and (y == 1 or (y >= 3 and y <= 15) or y == 18))
                                  or ((x == 9 or x == 10) and (y == 1 or (y >= 3 and y <= 16) or y == 18))
                                  or (x == 11 and (y == 1 or (y >= 3 and y <= 5) or (y >= 7 and y <= 16) or y == 18))
                                  or (x == 12 and (y == 1 or y == 3 or (y >= 9 and y <= 12) or y == 16 or y == 18))
                                  or (x == 13 and (y == 1 or (y >= 8 and y <= 11) or y == 18))
                                  or (x == 14 and (y == 1 or (y >= 9 and y <= 11) or y == 17))
                                  or (x == 15 and (y == 2 or y == 10 or y == 17))
                                  or (x == 16 and (y == 2 or y == 3 or y == 9 or (y >= 14 and y <= 16)))
                                  or (x == 17 and (y >= 4 and y <= 13)))):
                                c = RGB (0, 0, 0)
                                dn["MATERIAL%d%d%d" % (x, y, z)].diffuseColor.setValue (c)
